const localQuotes = [
  {
    text: "You have to deliberately disallow negative thoughts in your mind because the content and character of your mind must be rich and positive enough to pull toward you what you want",
    author: "Albert D. Bangura",
  },
  {
    text: "Do yourself a favor and love wisdom. Learn all you can, then watch your life flourish and prosper!",
    author: "Proverbs",
  },
  {
...
// DoM elements
const newQuote = document.querySelector(".new__quote");
const prevQuote = document.querySelector(".prev__quote");
const quoteText = document.querySelector(".quote-text");
const authorText = document.querySelector(".author__text");
console.log(newQuote);

console.log("------Total Number of qoutes---------");
const numOfQuote = localQuotes.length;

let quoteNumber = 0,
  quote;
const quoteGenerator = function () {
  if (quoteNumber > localQuotes.length) {
    quoteNumber = 0;
  }
  quoteNumber++;
  console.log(quoteNumber);
  quote = localQuotes[quoteNumber];
  console.log(quote);
...
const prevQuoteGenerator = function () {
  if (quoteNumber < 0) {
    quoteNumber = localQuotes.length;
  }
  quote = localQuotes[--quoteNumber];
...
prevQuote.addEventListener("click", prevQuoteGenerator);

/******************************/
// Practice with Array Methods
/*****************************/
/* // Finds the first occurrence of the obj
const author = localQuotes.find((objEl) => objEl.author === "Napoleon Hill");
console.log(author);

console.log("-----------Napoleon Hill-------------");
// Gets all qoutes by Napolean Hill in an array
const author1 = localQuotes.filter((objEl) => objEl.author === "Napoleon Hill");

// Use forEAch to display all qoutes of Napoleon Hill
author1.forEach((quote) => console.log(quote.text));

console.log(author1);

console.log("-----------Albert Einstein-------------");
// Gets all qoutes by Napolean Hill in an array
const author2 = localQuotes.filter(
  (objEl) => objEl.author === "Albert Einstein"
);

author2.forEach((quote) => console.log(quote.text));

// map method as a loop
// Looping through the localQuotes array
 */
